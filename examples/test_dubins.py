...
# Define waypoints
waypoints = [
    Waypoint(latitude=34.05, longitude=-118.25, heading=90.0, altitude=100 * ureg.meter, name = "Waypoint 1"),
    Waypoint(latitude=34.10, longitude=-118.15, heading=180.0),
    Waypoint(latitude=34.15, longitude=-118.05, heading=270.0, name = "Waypoint 3"),
    Waypoint(latitude=34.20, longitude=-117.95, heading=0.0, name = "Waypoint 4"),
]

# Define parameters
speed = 50.0  # Speed in m/s
bank_angle = 20.0  # Bank angle in degrees
